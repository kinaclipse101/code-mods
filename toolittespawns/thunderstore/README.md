...
due to the way spawn points are chosen, mods that increase the player cap make it so a majority of spawn points are just .,,. unable to be picked especially in singleplayer..,., you can see this the most on verdant falls where only a single spawn is available if the player cap is set to 16.,..,
